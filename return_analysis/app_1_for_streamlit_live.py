...
import os  # File path theek korar jonno add kora hoyeche
...
# ==========================================
# 1. API SETUP (Hybrid: Local + Live Ready)
# ==========================================
try:
    # Jodi app-ti Streamlit Cloud-e Live thake, tahole vault theke key nibe
    YOUR_API_KEY = st.secrets["GEMINI_API_KEY"]
except Exception:
    # Local PC-te testing-er jonno direct key bebohar korbe
    YOUR_API_KEY = "AIzaSyB8Hs0UjBKkxmxK_iXiA90V0oyGd9Cj30M"
...
def load_data():
    try:
        # App-ti je folder-e ache tar ashol thikana (Absolute Path) ber kora
