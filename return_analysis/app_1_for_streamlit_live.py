...
# ==========================================
# 1. SECURE API SETUP (Live Deployment)
# ==========================================
# Ekhon API key secure vault theke asbe
try:
...
# ==========================================
# 2. DATA LOADING (Ultra Memory Optimized)
# ==========================================
@st.cache_resource
def load_data():
    try:
        # Gross Units, Return Units ebong GMV (Gross Sale) add kora ache
